...
//
// v4 (April 28, 2026):
//   Built on v3 research-grade rebuild. Adds:
//     (1) corrected attribution L.H. Roberts throughout (was inconsistent
//         H.H./L.H. across v1–v3)
//     (2) the founding 1826 American tent-circus thread anchored at Southeast
//         Centre, with full personnel from the Brewster Standard, February 25,
//         1887 ("The Old Showmen") sourced from Seth B. Howes's direct testimony
//     (3) the village's pre-1887 advance knowledge of the watershed (May 1878
//         surveyors at Hiram Paddock's; March 1882 dam-at-Southeast-Centre
//         confirmation; fall 1882 dam-near-Armstrong-manufactory location)
//     (4) the post-watershed adaptive commercial reuse pattern (Lot 3 Poplar
//         Tea House 1930–33; Lot 2 Camp Graystone 1941 and Chateau Stonehenge
//         1948–72; Lot 10 schoolhouse-to-residence 1929 conversion)
//     (5) Brewster Standard chronological issue list expanded from 12 to ~30
//         dated references
//     (6) Sears Crosby = Seth S. Crosby identity confirmed
//     (7) Crane family commercial cluster (Joseph Crane 1773 day book through
//         Squire/Belden Crane 1877)
//     (8) Hatesville attribution removed (no primary-source confirmation of
//         Roberts verbatim usage)
//   Operational scaffold (CORS, rate limiting, prompt caching, question
//   logging) unchanged from v3.
//
...
10. **When primary and secondary sources conflict, identify the conflict explicitly rather than choosing one silently.** Example: Bailey 1944 frames the founding 1826 circus as Nathan Howes's "Old Bet" elephant tour, citing Earl Chapin May's *From Rome to Ringling*. The 1887 *Brewster Standard* "Old Showmen" article — drawing on Seth B. Howes's direct testimony at age 71 — describes the founding as a Russian-duck canvas tent, not an elephant tour. The 1887 article is direct testimony from a participant; Bailey 1944 is tertiary (citing May 1932). The 1887 article is the stronger source. **When asked about the founding circus, lead with the 1887 testimony and note Bailey 1944's elephant framing as a secondary-source variant** — don't suppress the conflict.
...
### Roberts 1876 — L.H. Roberts Centennial Address
...
- "**The new Croton river dam and reservoir are being built, also, in the western part of the town**" — Roberts's own forward reference to the Middle Branch Reservoir then under construction at Drewville (in service 1878). The East Branch / Sodom Reservoir that would consume Southeast Centre itself was eleven years away from formal proceedings; Roberts had no way of knowing in 1876 that a separate dam in a different direction would be the one to take his neighborhood.
...
- **Joseph Crane day book, 1773** — Bailey 1944 cites Joseph Crane's day book as primary documentary evidence of pre-Revolutionary Crane family activity at Southeast. Joseph Crane is the Crane patriarch from whom the "Crane's Hill" / Joe's Hill name derives.
...
### Brewster Standard
Primary newspaper of record. Key issues cited in this research, listed chronologically:

**1872–1880 (the working village at peak):**
- **August 3, 1872** — Jacob O. Howes wanted ad seeking "a girl who is willing to work" for general housework, separate cook position; placed at Sodom.
- **May 24, 1873** — display advertisement for a public lecture by Rev. Wm. M. Taylor of the Broadway Tabernacle Church, NYC, on the life and work of Sir Walter Scott, to be delivered at the Southeast Centre Presbyterian Church on June 3, 1873.
- **October 1, 1875** — no-license / temperance editorial; willows along the Croton near "the blacksmith shop" felled; Macoubrey returning to pulpit.
- **January 14, 1876** — "South East Centre" column: "Mud Pond has been yielding a fine supply of perch and pickerel to the numerous fishermen of this neighborhood."
- **March 2, 1877** — "South East Centre" column reports the parsonage (Lot 7) repurposed as charitable shelter for the homeless beginning April 1, 1877.
- **March 23, 1877** — Daniel Reed stair injury at the village; G.W. Hall reference; Hotel de Jonson reference; the "Shows and Showmen" column (Egbert and Elbert Howes joining the P.T. Barnum Show; Henry Barnum probably managing London Show post-sale; Brewster circus men with Van Amburgh).
- **May 4, 1877** — "Squire Crane" the village blacksmith; Col. Seth O. Crosby barn raising attended by D. Stannard as chief engineer; B.D. Everett / Storm references; "Sodom Museum" reference; Borden Milk Factory operations.
- **August 24, 1877** — Margaret Silk's wall objection to S.B. Howes (Lot 1).
- **August 31, 1877** — Croton bridge de-roofed by storm (originally a covered bridge); Crane's blacksmith shop; Thaddeus R. Knox painting and kalsomining trade with son working on Presbyterian Church; "John Yale is home for a vacation. The care of Gotham's health so wears on his own as to necessitate a few breaths of country air"; unanimous call to Rev. A. R. Macoubrey to return to the pulpit.
- **September 21, 1877** — Col. S.O. Crosby in residence at Southeast Centre (his daughter Fannie returning from West); Belden Crane operating cider press at Southeast Centre, producing vinegar and apple-whiskey; Amos Birch in show business — narrowing the death window for Jacob O. Howes's co-executor.
- **May 10, 1878** — surveyors quartered at Hiram Paddock's house; speculation about "site for the new dam at Southeast Centre" alongside competing rumors about Housatonic and Ten-Mile River projects. **First documented village awareness of the watershed coming.**
- **June 28, 1878** — Seth painting J.O.H. residence; E.E. Birch tenancy; documents Seth's stewardship work at Jacob's house lot before the formal October 1878 Cole transfer to Seth.
- **July 5, 1878** — Nathan A. Howes obituary; describes him as "the father of the Exhibition business in this country," recounts itinerant rope walker at Haviland Hollow hiring him as assistant at $1/day in 1811.
- **October 11, 1878** — multi-item village column: Stonehenge nearing completion (full architectural snapshot); Charles Mygatt tenant in Daniel Reed's house; Walter Weeds ox-shoeing facility being built; school district trustee election won by Ezra Wright over William Storm and Francis Burdick (Morgan Townsend chairing).

**1882–1890 (the watershed comes):**
- **March 24, 1882** — "The appearance of things during the past two weeks points very strongly to the conclusion that a reservoir is to be built at Southeast Centre." Reports New England Railroad track relocation past William A. Storm's residence about 300 feet south of existing bed because existing bed will be flooded ~6 feet under contemplated reservoir.
- **Fall 1882** — unsigned historical article ("A Bit of History") written for inclusion in corner-stone of new Brewster Presbyterian Church; pins dam location: "The survey locates the dam at Southeast Centre, near a sash and blind manufactory, owned by Isaac Armstrong. If the dam is built a fine farming section will be flooded and many pleasant homes will be broken up." Same article documents Presbyterian church chronology, 1880 Brewster fire, Borden milk operations, Hunt hat bankruptcy.
- **July 25, 1884** — Stonehenge moved 50 feet back from highway by David Jennings of Patterson, contractor.
- **November 13, 1885** — "The large pipe organ hitherto located at the Southeast Centre Presbyterian church has been moved to the new Presbyterian church in this village."
- **February 25, 1887** — "**Old Showmen**" column documenting the founding of the American tent-circus industry from Seth B. Howes's direct testimony at age 71. Identifies the founding tour as Howes & Turner, April 1826: Nathan A. Howes designed a Russian duck canvas tent and raised it first near William Storm's residence at Southeast Centre; founding performance held "on a lot nearly opposite Stonehenge, the present palatial residence of Seth B. Howes" on town meeting day, drawing about a thousand paid attendees; tour traveled east as far as Bangor, Maine and returned about $3,000 net profit. Clown Sylvester Reynolds broke his neck attempting a somersault on the inaugural tour; Hart Crosby (brother of Sears Crosby = Seth S. Crosby of Southeast, then living at Fort Dodge, Iowa) volunteered as replacement and "succeeded admirably, even to breaking his neck in attempting a somersault." Wagons built by Mr. Cole, the father of George Cole of Southeast Centre. Iron work by Phineas Trowbridge of the same village. **This is the strongest single primary source on the founding moment of the American tent-circus industry, in Seth's own words.** Same issue: George W. Hall coal-trade ad confirming his continued operation; Mrs. William Warren "For Sale or to Rent" advertisement.
...
- **June 20, 1890** — Howes return from Chicago.
...
**1891–1955 (post-watershed adaptive reuse):**
- **June 12, 1891** — "If not sold privately before Monday, June 15th, the Presbyterian church property at Southeast Centre will be offered for sale by auction in front of the Town Hall at 10 o'clock a.m. on that day." Auction either held or preempted by the July 1, 1891 private sale to Yale and Baxter.
- **June 28, 1901** — Sodom school district vote, "Seth B. Howes' heirs made that site prohibitive by paying $1,000 for it"; merger debate editorial.
- **September 13, 1901** — "School District, No. 6, Sodom, now has full title to the old Presbyterian church property at Southeast Centre, in consideration of a check for $300 drawn by Trustee Storm this week in favor of Mrs. E. O. Baxter. John R. Yale has half interest in the deal." Resolves the church-to-school transaction with named parties: William Storm as district trustee signing the $300 check; Emma O. Baxter and John R. Yale as joint sellers.
- **June 24, 1927** — "Notice of Sale of Sodom School Property" auction notice.
- **April 27, 1928** — A.P. Budd advertises Stonehenge for sale; described as the Heartfield estate.
...
- **August 25, 1933** — Court-ordered auction notice for the Foster lot (Lot 3) following the Carrolls' Poplar Tea Room bankruptcy. Includes detailed chattel inventory: 32 tea cups, 47 bouillon cups, 23 tea room chairs. References Damage Parcel No. 15 3-8 boundary detail (Charles H. Collis Commissioner, G.M. Birdsall Chief Engineer, Map No. 1 / Sheet 7, May 14, 1896). Period landmarks named: button ball tree, picket fence, stone wall.
- **July 24, 1941** — display advertisement for Camp Graystone Junior Boys Camp at Stonehenge, operated by D. Earl Santore. Eight-week summer season; $200 for boys arriving from outside the area, $160 for local boys. Telephone Brewster 635.
- **March 16, 1944** — Bailey "Historical Sketch of Brewster" full text; comprehensive published narrative of town history through the watershed era and after.
- **November 12, 1948** — Chateau Stonehenge opening night dinner. Includes Mrs. William B. Reed (daughter of Col. Crosby per the article) attribution of the Sodom name to a post-Civil War temperance society. Article describes structural condition of the building 70+ years after Seth's construction: 3-story stonework intact, modern bar to right of entrance, two main dining rooms.
- **September 29, 1955** — formal liquor license No. 30-RL-297 issued to Angele Christaud for Chateau Stonehenge.
...
- **Brewster Standard, November 12, 1948 — "Chateau Stonehenge Opens Officially"**: opening night dinner article. Sources for: structural condition of Stonehenge in 1948, the Sodom name origin via Mrs. William B. Reed family memory (post-Civil War temperance society), the guest list including Reuben Howes (Seth's grandnephew, still at Morningthorpe) and Mrs. William B. Reed (daughter of Col. Crosby per the article; granddaughter of Jacob O. Howes through her mother Martha Howes Crosby).
...
- **Nathan Alva Howes**: b. **April 22, 1796** at "Howes homestead" in South East Centre. Eldest of the three. His obituary described him as "**the father of the Exhibition business in this country**," having entered the trade in 1811 at age 15 (an itinerant rope walker at Haviland Hollow hired him as assistant at a dollar a day). Later operated a riding school and gymnasium on the Storms place east of Brewsters, where his younger brother Seth, R. Wilson Howes, and Richard Sands prepared themselves for circus careers. **Per Seth's direct testimony in the *Brewster Standard*, February 25, 1887 ("The Old Showmen"), Nathan was the designer of the canvas tent of Russian duck used on the founding 1826 Howes & Turner tour — the founding event of the American tent-circus industry. The tent was raised first near the residence of William Storm in Southeast Centre, then pitched for performance "on a lot nearly opposite Stonehenge, the present palatial residence of Seth B. Howes" on town meeting day, April 1826, drawing about 1,000 paid attendees. Nathan served as manager, ring master, and slack-wire performer.** Southeast Town Supervisor 1840-42; State Senator 1851+ (two terms). Wife: **Clarissa Crosby** — confirmed in his obituary; this marriage explains the Crosby family's pervasive presence throughout the corridor's deed record as boundary neighbors and witnesses across three generations. Sold 120-acre Yale Tract to Enos C. Yale January 29, 1858 (Liber 33/192, $13,000). Also owned brick block on Brewster Main Street (Wells 1977). **Died June 28, 1878 at residence of son-in-law Francis E. Foster, Esq., at Brewsters, age 82y 2m 6d.** Obituary in the *Putnam County Standard*, July 5, 1878. **Residence at Southeast Centre not specifically documented in this research.**
...
- **R. Wilson Howes** (= Robert W. Howes): "very promising acrobat and rider" with the founding 1826 Howes & Turner tour. Prepared circus career at Nathan's Storms place. Died summer 1886 per the February 25, 1887 *Brewster Standard* "Old Showmen" column.
- **Egbert and Elbert Howes**: twin brothers, sons of Nathan A. Howes per Nathan's July 5, 1878 obituary. Active in the show business; in March 1877 left Brewsters to travel with the **P. T. Barnum Show** for the season, alongside Peter Halstead and Arthur Reed of Brewsters (per *Brewster Standard*, March 23, 1877, "The Shows and Showmen").
- **Augusta Howes** (= Ann Augusta Howes): Nathan A. Howes's daughter; married Francis E. Foster, Esq. Their marriage created a structural Howes-Foster-Barnum hinge — Francis E. Foster was Nathan's son-in-law and was also the father-in-law of Frederic S. Barnum (who married Emma R. Foster, Francis E.'s daughter). Nathan died at Francis E.'s residence in Brewster on June 28, 1878.
...
- **Seth S. Crosby (= Sears Crosby in period sources)**: Main Street upper parcel chain to 1830 (Liber G/97, Seymour Allen → Seth S. Crosby). Active in SE Centre real estate through 1850s. **The "S.O." reading on Sidney & Neff and Beers maps is an engraver error for "S.S." — confirmed by both the deed record and the 1854 O'Connor map (which reads correctly as "S.S. Crosby"). The error was formally corrected by a certificate at Liber G/105.** **In period testimony, Seth S. Crosby is called "Sears Crosby" — a familiar/alternate form common in 19th-century New England Yankee usage. The *Brewster Standard*, February 25, 1887 ("The Old Showmen") identifies "Sears Crosby, formerly of this town" — meaning Seth S. Crosby, who held the Main Street parcel from 1830 through the 1857 Baker & Mygatt insolvency assignment, after which he disappears from the corridor deed record (consistent with relocation following financial collapse).** His brother Hart Crosby joined the founding 1826 Howes & Turner circus tour as a performer; by 1887 Hart was living in Fort Dodge, Iowa. **The Crosby family was thus among the founders of the American tent-circus industry alongside the Howes brothers** — corroborating the structural Howes-Crosby alliance documented through Nathan A. Howes's marriage to Clarissa Crosby.
- **Hart Crosby**: brother of Sears Crosby (= Seth S. Crosby, see above). Joined the founding 1826 Howes & Turner tour as an acrobat replacement after the original clown Sylvester Reynolds broke his neck attempting a somersault. Per the *Brewster Standard*, February 25, 1887 ("The Old Showmen"), Hart "wanted to fill Reynolds' place in the ring, and succeeded admirably, even to breaking his neck in attempting a somersault." Survived the injury; emigrated west; by 1887 living at Fort Dodge, Iowa.
- **Seth O. Crosby = "Colonel Crosby"**: m. Jacob O. Howes's daughter Martha. Co-executor of Jacob's estate. Conveyed west-of-highway river tract to Jacob 1874 ($10,000); the tract was reconveyed by Jacob to Martha M. Crosby for $1 nominal Feb 1876 (likely unwinding a security arrangement). **Identified as "Colonel Crosby" of Southeast Center in the 1948 Christaud opening article — Mrs. William B. Reed (his daughter per the article) was a guest at the Chateau Stonehenge opening night dinner and provided the family-memory testimony attributing the "Sodom" name to a post-Civil War temperance society that applied it derogatorily to the village's pre-temperance whiskey trade.** **Documented active in the village in 1877: hosted a barn raising on May 1, 1877 with D. Stannard as chief engineer (Brewster Standard, May 4, 1877); his daughter Fannie returned from a visit to the West in September 1877 (Brewster Standard, September 21, 1877). The 1877 references narrow the death-date window for the Crosby figure who later released parcels to the City of New York in the 1890s as Jacob's co-executor.** **Note**: Some transcriptions render the executor name as "Bette O. Crosby" — this appears to be a scribal error variant; the documented identification is **Seth O. Crosby**. **Note also**: Seth O. Crosby is distinct from Seth S. Crosby (Sears Crosby) — Seth O. is a generation younger, married into the Howes family, and held Southeast Centre property in the 1870s-1890s alongside his wife Martha.
...
- **Mrs. William B. Reed (daughter of Col. Seth O. Crosby per the November 12, 1948 *Brewster Standard*; granddaughter of Jacob O. Howes through her mother Martha Howes Crosby)** — at Stonehenge opening night dinner 1948; the source of the family-memory testimony attributing the "Sodom" name to a post-Civil War temperance society. **Her birth name is not primary-source confirmed in this research.**
...
### THE YALE FAMILY
- **Enos C. Yale**: NYC resident; purchased 120-acre Yale Tract from Nathan A. Howes January 29, 1858 (Liber 33/192, $13,000). "**E. Yale**" on 1867 Beers map (NOT "E. Yule" — that's a cartographer's rendering; deed record unambiguous as Yale). **Died October 10, 1876 of Bright's disease**, per his obituary in the *Putnam County Standard*, October 13, 1876 (the obituary describes him as having spent "about twenty years in show business" before purchasing the Southeast Centre farm and retiring; it dates the purchase "about 1856" — period memory off by approximately two years from the Liber 33/192 date of January 29, 1858, but anchoring the same transaction). Left a wife and four children, and his mother (then over ninety) also survived him. Widow **Lydia M. Yale** + daughters **Mary E.** and **Emma C. Yale** + son **Howard C. Yale** (then 17 in 1880).
- **John R. Yale (May 8, 1855 – July 17, 1925)**: NY State Assemblyman 1902-1913 and 1921-1925; RNC delegate 1904. Married **Alice Penny May 8, 1880**. Died Albany Hospital. **The kinship between Enos C. Yale and John R. Yale is not established in the primary record reviewed in this research** — though John R.'s repeated involvement in real-estate transactions adjacent to the Yale Tract across the decade of the watershed takings is a documentary pattern more consistent with family succession than with arm's-length acquisition. **Confirmed at Southeast Centre in summer 1877: the *Brewster Standard*, August 31, 1877 reports "John Yale is home for a vacation. The care of Gotham's health so wears on his own as to necessitate a few breaths of country air" — consistent with John R. having New York City employment in some health-related capacity. April 1891: co-purchased the former Presbyterian Church lot (Lot 10) with James D. Baxter for $104. April 1893: 1893 watershed deed for Parcel 15B identifies northern boundary as "John R. Yale formerly Kate E. Crane." September 13, 1901: per the *Brewster Standard*, John R. Yale held half-interest in the Sodom school district's $300 acquisition of the former Presbyterian Church property — "School District, No. 6, Sodom, now has full title to the old Presbyterian church property at Southeast Centre, in consideration of a check for $300 drawn by Trustee Storm this week in favor of Mrs. E. O. Baxter. John R. Yale has half interest in the deal." The transaction had been informally orchestrated through a same-day double recording on September 10, 1901 — Yale-and-Alice quit-claim to Emma O. Baxter at noon; Baxter-to-District warranty deed at 10 a.m. (recorded earlier than the prior conveyance to give the school district clean-title record).**
...
- **William Storm (also W. Storm and W. A. Storm in some sources)**: a multi-decade geographic anchor at Southeast Centre. **In 1826, the founding canvas tent of the American tent-circus industry was raised "near the residence of William Storm" — per the *Brewster Standard*, February 25, 1887 ("The Old Showmen"), drawing on Seth B. Howes's direct testimony.** **In the 1870s-1900s** Storm appears as: architect/builder for B.D. Everett's carriage house (May 1877); defeated school trustee candidate (October 1878, lost to Ezra Wright); reference point for the 1882 New England Railroad rerouting ("the New England R. R. track, which lies beyond the residence of Mr. W. A. Storm" per *Brewster Standard*, March 24, 1882); and as district trustee signing the September 1901 $300 check for the school district's acquisition of the former church property (per *Brewster Standard*, September 13, 1901). **Storm's residence is a recurring landmark across at least 75 years of corridor history but has not been definitively located on the 1867 Beers map.** Whether the 1826, 1877, 1882, and 1901 references are all to the same man, or to a William and a William A. Storm in successive generations, is not yet established in the primary record.
...
### THE 1826 FOUNDING OF THE AMERICAN TENT-CIRCUS INDUSTRY AT SOUTHEAST CENTRE
The strongest single primary-source description of the founding of the American tent-circus industry sits in a *Brewster Standard* column dated February 25, 1887, headed "The Old Showmen." The information was furnished directly by Seth B. Howes himself, then a "well preserved gentleman of 71 years" living at Stonehenge. The geographic anchors are specific to Southeast Centre:

- **The first canvas tent of the American circus industry was raised in Southeast Centre in 1826**, near the residence of William Storm. The canvas was made of Russian duck (a heavy plain-woven cotton/linen fabric used for sails) and was designed by Nathan A. Howes.
- **The first paid performance was held on town meeting day, April 1826, on a lot directly across Sodom Road from what later became Stonehenge.** About 1,000 paid attendees. Half a century later, when Seth built Stonehenge, he built it directly across the road from the lot where the founding performance had been held.
- **The personnel were nearly all local**: Nathan A. Howes (manager, ring master, slack-wire performer, tent designer); Seth B. Howes (age 10–11, participant); Sylvester Reynolds (clown, broke his neck attempting a somersault); Hart Crosby (brother of Sears Crosby = Seth S. Crosby, took Reynolds's place, also broke his neck attempting a somersault, survived); Sam Stickney (the only hired professional); Robert W. Howes (acrobat and rider, died summer 1886); Aaron Turner (advertising; mortgaged his farm to raise capital — meaning the founding of the American circus industry was financed in part by farm mortgages); Ammi Ponier of Somers (partner); William F. Fowler of Brewster (the only living person in 1887 who had attended and paid admission); Charles Smith on clarinet; Norman Colston on violin.
- **The wagons were built by Mr. Cole, the father of George Cole of Southeast Centre**, with iron work by Phineas Trowbridge of the same village, painted white and red. **This documents the corridor's wagon-building trade as continuous from 1826 founding through the 1890 watershed taking** — the same George Cole who lost "his home and his business" to the City of New York in 1890.
- The four wagons drawn by twelve horses traveled east as far as Bangor, Maine. The 1826 tour returned approximately $3,000 in net profit. At Springfield, Massachusetts, the first nighttime tent-circus performance in America was held, lit by tin lamps filled with whale oil set on pegs.

**This is the founding geographic moment of the American tent-circus industry, anchored at Southeast Centre by direct primary-source testimony from one of its two founders.** When asked about Southeast Centre's circus history, this 1887 testimony is the strongest source — superseding the secondary "Old Bet elephant" framing from Bailey 1944 (which itself quoted Earl Chapin May's *From Rome to Ringling*, 1932). Bailey's elephant story may belong to a different 1826 tour or may be folk-memory variant; the 1887 article is direct testimony and has the stronger source quality.

**The Crosby family was thus structurally embedded in the founding of the American circus industry alongside the Howes brothers** — Hart Crosby on the founding tour, his brother Sears Crosby (= Seth S. Crosby) at Southeast Centre, and a generation later Nathan A. Howes married Clarissa Crosby. The Howes-Crosby family alliance documented through the deed record reflects this circus-trade alliance as well.

### THE VILLAGE'S ADVANCE KNOWLEDGE OF THE WATERSHED, 1878–1882
The 1887 New Aqueduct Notice was the formal beginning of the takings, but it was not the first the village heard of the project. The corridor's primary-source record documents nine years of advance awareness:

- **May 10, 1878 (*Brewster Standard*)**: Surveyors quartered at Hiram Paddock's house. The village correspondent reports speculation that "a site for the new dam at Southeast Centre is to be determined upon," alongside competing rumors that the project might involve diverting the Housatonic River into the Croton, or that only the Ten-Mile River would be utilized.
- **March 24, 1882 (*Brewster Standard*)**: "The appearance of things during the past two weeks points very strongly to the conclusion that a reservoir is to be built at Southeast Centre." Reports that a portion of the New England Railroad track running past William A. Storm's residence is to be relocated about 300 feet south of its existing bed, on higher ground, because the existing road bed will be flooded under the contemplated reservoir to a depth of about six feet.
- **Fall 1882 (*Brewster Standard*)**: An unsigned historical article ("A Bit of History") written for inclusion in the corner-stone of the new Brewster Presbyterian Church pins the dam location: "**The survey locates the dam at Southeast Centre, near a sash and blind manufactory, owned by Isaac Armstrong. If the dam is built a fine farming section will be flooded and many pleasant homes will be broken up.**" The article documents Presbyterian church chronology, the 1880 Brewster fire, Borden milk operations, and the Hunt hat bankruptcy in the same context.

**The village had clear knowledge of what was coming for at least nine years before the formal 1887 Aqueduct Notice.** The 1882 article's acknowledgment that "many pleasant homes will be broken up" is the village's own foreknowledge of its dispossession captured in print. This is structurally significant for understanding decisions made at the corridor between 1878 and 1887: tenancies, sales, and improvements during this window were made by people who knew or strongly suspected the watershed was coming.

**Isaac Armstrong's sash and blind manufactory** is the geographic anchor for the dam site. Armstrong's manufactory — a window-and-shutter shop — stood at the location where the City would later build the East Branch Reservoir dam. By the time the City formally took the parcel in the 1890 awards, Armstrong's grist mill, sash-and-blinds manufactory, and ice house were the entire commercial complex at the dam site; the City paid $6,378.23 for the takedown of the whole operation.
...
- **Brewster Sanitary** (Chapter 189, Laws of 1893): claimed west-of-highway parcels. Melissa Birch received Middle Branch parcel for $13,375 (1902, Liber 89/144-149).

**Stonehenge proper — the house lot east of the highway, modern Lot 2 — was NEVER condemned.** Never assigned a watershed parcel number, never received an award, never appeared in any release instrument. The unbroken private deed chain from Seth through current ownership confirms Lot 2 has been private property without interruption. Seth's separate west-of-highway river strip was taken under the Brewster Sanitary proceeding for $3,215 (Parcel No. 6, Liber 80/495–498). Seth's obituaries described "condemnation proceedings compelled Mr. Howes to vacate Stonehenge" — but this is journalistic shorthand, not legal fact. The watershed stripped the surrounding agricultural context while leaving the road-frontage lot intact.
...
### POST-WATERSHED ADAPTIVE COMMERCIAL REUSE OF THE CORRIDOR, 1900–1972
After the 1887–1900 takings, the surviving buildings at Southeast Centre did not stand still. Through the first half of the twentieth century, structures along the relocated Old Route 22 cycled through successive uses to remain economically viable. The pattern was consistent across the corridor: residence to commercial use to residence again, each building finding the next reason to stay standing.

- **Lot 3 (Foster corner)**: Laura Lee Tea House operated by Mrs. Ross from at least July 2, 1915 (Brewster Standard advertisement; 1965 "Fifty Years Ago" retrospective confirmed identification at "the Ebenezer Foster house at Sodom"). Marie DeTour Carroll of Manhattan acquired December 10, 1930 (Liber 160/315, $100); the Carrolls remodeled c. 1931 as the **Poplar Tea House**, adding two bathrooms and a vapor heating system. Marie Carroll assigned for benefit of creditors December 22, 1931 (Liber 167/179) to Manhattan attorney Kenneth O. Shrewsbury. Operations continued under Mr. and Mrs. Alfred Smith (employees) until the **March 17, 1933 fire** (Brewster Standard front page: "Fire Destroys Old Sodom Landmark — Katonah Fireman Seriously Injured"). The structure survived. Subsequent **August 25, 1933** court-ordered auction notice listed detailed chattel inventory: 32 tea cups, 47 bouillon cups, 23 tea room chairs.
- **Lot 2 (Stonehenge)**: After the Heartfield estate (Ruhamah Heartfield d. March 4, 1928) the property cycled through commercial uses while remaining in private hands. **April 27, 1928 Brewster Standard**: A.P. Budd Sole Agent listing "Country Estate known as Stonehenge with grounds, tenant dwellings, etc., at Southeast Centre" — listed as Heartfield estate property for an extended period. Eventually sold to Sampson Scott of NYC c. 1933. **Summer 1941**: D. Earl Santore operated **Camp Graystone Junior Boys Camp** at Stonehenge for the eight-week summer season (Brewster Standard display advertisement, July 24, 1941; $200 for boys arriving from outside the area, $160 for local boys; Telephone Brewster 635). **November 1948**: Mme **Angele Christaud** opened **Chateau Stonehenge French restaurant** after substantial restoration (Brewster Standard, November 12, 1948 — opening night dinner article). The 1948 article describes the structural condition 70+ years after Seth's construction: 3-story stonework intact, modern bar to the right of the entrance, two main dining rooms. **September 29, 1955**: formal liquor license No. 30-RL-297 issued to Angele Christaud. The Christaud restaurant operated for twenty-four years until 1972.
- **Lot 10 (former Presbyterian Church)**: Acquired by Sodom School District No. 6 for $300 in 1901, rebuilt as the new district schoolhouse, sold by the school district to Nellie W. Beal at the June 1927 auction, sold by P.F. Beal (the actual auction buyer) to **J.J. Donohue** (NYC contractor and builder) February 2, 1929 (Liber 149/197). Donohue **converted the schoolhouse to a residence**: residential windows where classroom windows had stood, chimney for domestic heating, siding replaced, additions extending footprint. **The clerestory windows from the 1901 schoolhouse remain visible along the roofline today** — direct physical evidence the current 112 Sodom Road residence is the converted schoolhouse, not a replacement. The Donohues did not demolish; they converted.

**The pattern.** Stonehenge survives because it remained continuously useful, not because anyone was preserving it as a relic. The same is true of the Foster corner, the converted schoolhouse at 112 Sodom Road, and the parsonage at 100 Sodom Road. The corridor's twentieth-century survival was a function of adaptive economic reuse — successive commercial phases keeping buildings in service through the very years a less-occupied house might have been demolished or left to decay.
...
- **Pulpit lineage** (per the fall 1882 *Brewster Standard* historical article and the August 31, 1877 column): First pastor **Rev. Winthrop Bailey**, served from the 1854 dedication until his death in 1865. After a vacancy, **Rev. A. R. Macoubrey** was settled in 1867 and served continuously through 1882, with one short interruption as pastor of a church at New Rochelle. By August 1877, the Macoubrey-pastorate had been interrupted: the August 31, 1877 *Brewster Standard* reports a unanimous congregational call for him to return — "no one but Mr. Macoubrey could possibly fill the vacant pulpit." Macoubrey accepted; Thad Knox and his son repainted and kalsomined the church in advance of his return. The church served as a cultural venue beyond its religious function: the *Brewster Standard*, May 24, 1873 carried a display advertisement for a public lecture by **Rev. Wm. M. Taylor of the Broadway Tabernacle Church, New York City**, on the life and work of Sir Walter Scott, to be delivered at the Southeast Centre Presbyterian Church on June 3, 1873. By March 1877 the parsonage had been repurposed as a charitable shelter for the homeless beginning April 1, 1877 (March 2, 1877 *Brewster Standard*). The institutional decline became formal in fall 1882: the congregation was building a new Presbyterian church at Brewster, with the corner-stone about to be laid. "**The new church now in process of erection, while it is the third Presbyterian church of the town, will probably be known as the Presbyterian church of Brewsters.**" Three years later, on November 13, 1885, the *Brewster Standard* noted: "**The large pipe organ hitherto located at the Southeast Centre Presbyterian church has been moved to the new Presbyterian church in this village.**" The instrument went where the congregation had gone. The formal disposition of the real estate followed in 1891. The *Brewster Standard*, June 12, 1891 ran the auction notice — "If not sold privately before Monday, June 15th, the Presbyterian church property at Southeast Centre will be offered for sale by auction in front of the Town Hall at 10 o'clock a.m. on that day." The Yale-and-Baxter sale at $104 dated July 1, 1891 either preempted the auction or was the auction outcome.
...
**The 1826 founding tour and Stonehenge's geographic anchor**: Per Seth B. Howes's direct testimony in the *Brewster Standard*, February 25, 1887 ("The Old Showmen") at age 71, the founding 1826 Howes & Turner tour — the founding event of the American tent-circus industry — staged its inaugural paid performance "**on a lot nearly opposite Stonehenge, the present palatial residence of Seth B. Howes**" on town meeting day, April 1826. About 1,000 paid attendees. The canvas tent of Russian duck (designed by Nathan A. Howes) had been raised first near the residence of William Storm, then pitched for the performance directly across the road from what would, half a century later, become the Stonehenge site. **Seth's choice of Stonehenge's location, when he came to build in 1870–84, was not coincidental: he built directly across the road from the lot where the founding performance of his trade had been held.** Wagons for the founding tour were built by Mr. Cole — the father of George Cole of Southeast Centre — with iron work by Phineas Trowbridge, painted white and red. The four wagons drawn by twelve horses traveled east as far as Bangor, Maine; net profits about $3,000.
...
- **June 28, 1878 (*Brewster Standard*, "South East Centre" column)**: Seth painting and repairing the J.O.H. residence (the old Jacob O. Howes house lot Seth was assembling into the larger Stonehenge holding). E.E. Birch documented as tenant during this stewardship period. This is the moment Seth was personally working on the property he had been assembling since 1870 but had not yet permanently occupied.
- **October 11, 1878 (*Brewster Standard*, "South East Centre" column)**: Stonehenge "slowly approaching completion." Interior finish work in advanced stage — wainscoting, doors, interior blinds, mantles installed; grounds being landscaped. The house is described as habitable enough that the writer has clearly walked through it. **Stonehenge was therefore nearly complete in fall 1878 but stood not yet permanently occupied for another six years until 1884.** During the intervening 1878–1884 period, the house likely stood tenanted or held vacant; this aligns with the established project record showing tenancies on adjacent Howes-family properties during the same window.
- **1884**: Couple came to America permanently; Stonehenge their first permanent American home.
- **Summer 1884 (*Brewster Standard*, July 25, 1884)**: Stonehenge moved approximately 50 feet back from the highway by **David Jennings of Patterson**, contractor. **This is a structural fact about the present Stonehenge: the house standing today is the same house Seth had been building since 1870–84, but it sits about 50 feet farther back from the road than it originally did.** The 1884 move came simultaneously with Seth and Amy's permanent move from England to Stonehenge as their first American home.
...
- **June 1889 – June 1890**: Seth and Amy spent approximately a year in Chicago (per the *Brewster Standard*, June 20, 1890, reporting their return). The Chicago year coincides with the East Branch Reservoir construction era and may be connected to the Johnstown Flood (May 31, 1889) and the subsequent worker death at the East Branch dam in fall 1889 — both events documented in the existing project record as plausibly contributing to Seth and Amy's later move from Stonehenge to Morningthorpe (Turk Hill, by July 13, 1894).
...
**Post-Heartfield commercial era (1928–1972)**:
- **April 27, 1928 (*Brewster Standard*)**: A.P. Budd Sole Agent listing "Country Estate known as Stonehenge with grounds, tenant dwellings, etc., at Southeast Centre." Listed as Heartfield estate property for an extended period — five years before the eventual sale. Listed alongside Hillside Cottage on Turk Hill Road and a building lot on Oak Street. The listing explicitly references "tenant dwellings" on the property.
- **Summer 1941 (*Brewster Standard* display advertisement, July 24, 1941)**: D. Earl Santore operated **Camp Graystone Junior Boys Camp** at Stonehenge for the eight-week summer season. $200 for boys arriving from outside the area, $160 for local boys. Telephone Brewster 635.
- **November 1948 (*Brewster Standard*, November 12, 1948)**: Mme **Angele Christaud** opened **Chateau Stonehenge French restaurant** after substantial restoration (Liber 346/484). The opening night dinner article describes the structural condition 70+ years after Seth's construction: 3-story stonework intact, modern bar to right of entrance, two main dining rooms. The article noted: "**The old stone work bears the mark of time. It never shifted; neither did the beams.**" Guests included Reuben Howes (Seth's grandnephew, still at Morningthorpe ~50 years after Seth's death) and Mrs. William B. Reed (daughter of Col. Seth O. Crosby per the article; granddaughter of Jacob O. Howes through her mother Martha Howes Crosby — **the source of the family-memory testimony attributing the "Sodom" name to a post-Civil War temperance society** that applied it derogatorily to the village's pre-temperance whiskey trade).
- **September 29, 1955**: formal liquor license No. 30-RL-297 issued to Angele Christaud.
- **1972 (Liber 705/1177)**: Christaud → Previous Owners. **The Christaud restaurant operated for twenty-four years.**
...
- **Fallon + Clarke** acquired (chain documentation note: Fallon and Clarke were the 1918 Hine grantees).
- **December 10, 1930 (Liber 160/315)**: Fallon and Clarke → Marie DeTour Carroll of Manhattan, $100 (recorded December 12, 1930). The Carrolls — identified in the August 1933 *Brewster Standard* auction notice as Mr. and Mrs. J. J. Carroll of New York — remodeled c. 1931 as the **Poplar Tea House**, adding two bathrooms and a vapor heating system and "fitting it up as a beautiful tea room." **Note**: previous project drafts gave this date variously as "December 1920" — this was a transcription error; the deed itself is December 10, 1930, recorded in Liber 160 (a 1930-era liber, not a 1920-era one). The August 25, 1933 auction notice back-citation to Liber 160/315 confirms the correct date.
...
**August 25, 1933 — Court-ordered auction notice**: Following the Carrolls' assignment for benefit of creditors and following the March 1933 fire, the property was offered at court-ordered auction. The notice (*Brewster Standard*, August 25, 1933) ran with detailed chattel inventory: 32 tea cups, 47 bouillon cups, 23 tea room chairs. References Damage Parcel No. 15 3-8 boundary detail (Charles H. Collis Commissioner, G.M. Birdsall Chief Engineer, Map No. 1 / Sheet 7, May 14, 1896). Period landmarks named: button ball tree, picket fence, stone wall — all of which still appear in subsequent deeds in the chain.
...
**Daniel Reed at the homestead, 1877–1878**: Three primary-source confirmations across thirteen months document Daniel Reed continuously at the D. Reed parcel:
- **March 23, 1877 (*Brewster Standard*, "South East Centre" column)**: "Mr. and Mrs. Daniel Reed returned to their home last Friday, after having been absent about two months visiting at their daughter's residence at Milltown. The morning after their return Mr. Reed slipped while going down a flight of stairs, and injured his side so severely that he has been confined to the house ever since." **Establishes Daniel Reed alive and at the homestead in March 1877, with a married daughter at Milltown** (a new family-connection lead for further research).
- **August 31, 1877 (*Brewster Standard*)**: "Miss Dora Dickson, who has been spending her vacation at Mr. Daniel Reed's, has returned to her duties in the Tarrytown Public School." **Daniel Reed well enough by August to host a vacationing teacher.**
- **October 11, 1878 (*Brewster Standard*, "South East Centre" column)**: **Charles Mygatt documented as tenant in Daniel Reed's house.** Daniel Reed continued to hold title; Mygatt appears as occupant. The Mygatt connection is structurally interesting: a Mygatt was named as one of the assignees of Seth S. Crosby's 1857 insolvency (Baker & Mygatt, Liber 31/526) — possibly the same Charles Mygatt or a relation. **Stacked with the 1877 references, Daniel Reed is now firmly placed as alive and holding title at the Reed homestead through at least October 1878**, with tenants in residence when not personally there.
...
- **September 13, 1901 (*Brewster Standard*)**: "School District, No. 6, Sodom, now has full title to the old Presbyterian church property at Southeast Centre, in consideration of a check for $300 drawn by Trustee Storm this week in favor of Mrs. E. O. Baxter. John R. Yale has half interest in the deal." **This resolves the church-to-school transaction with named parties**: William Storm as district trustee signing the $300 check; Emma O. Baxter and John R. Yale as joint sellers (each holding half interest). The *June 28, 1901 Brewster Standard* had earlier editorialized about the alternative — merging the Sodom school district with Brewster Union Free School District — which would have avoided "the difficulty entailed in the purchase of a site and the erection of a new school house at Southeast Centre." The merger was rejected; the September 1901 transaction is the resolution.

**For the full pulpit lineage (Rev. Winthrop Bailey 1854–1865; Rev. A. R. Macoubrey 1867–1882, with the unanimous August 1877 call for his return), the Taylor lecture of June 1873, the 1880s institutional decline arc (corner-stone of the Brewster church laid fall 1882; pipe organ moved November 13, 1885; June 12, 1891 auction notice), see Part 6, "The Presbyterian Church at Southeast Centre."**
...
**Yale family at the tract — Enos C. Yale and his death**:
Enos C. Yale was a New York City resident and almost certainly not a full-time farmer on this ground; the land appears to have been held as a productive asset, worked by tenants, with the family visiting or summering. **He died on October 10, 1876 of Bright's disease**, per his obituary in the *Putnam County Standard*, October 13, 1876. The obituary describes him as having spent "about twenty years in show business" before purchasing the Southeast Centre farm and retiring; it dates the purchase "about 1856" — period memory off by approximately two years from the Liber 33/192 date of January 29, 1858, but anchoring the same transaction. He left a wife and four children, and his mother (then over ninety) also survived him.

- **1885 (Liber 66/194)**: Howard → Lydia. Consolidated estate ahead of watershed dealings.

**John R. Yale and the Yale Tract neighborhood, 1877–1901**: Multiple primary-source references place John R. Yale at or near the Yale Tract from 1877 through 1901:
- **August 31, 1877 (*Brewster Standard*)**: "John Yale is home for a vacation. The care of Gotham's health so wears on his own as to necessitate a few breaths of country air." **Suggests John R. had New York City employment in some health-related capacity** and returned to Southeast Centre for periodic country rest. Consistent with John R. being a family member, possibly a son or nephew of Enos C. Yale, with city employment and a country residence at the Yale Tract or at a nearby family property.
- **April 1891**: John R. Yale co-purchased the former Presbyterian Church lot (Lot 10) with James D. Baxter for $104.
- **April 1893**: Watershed deed for Parcel 15B identifies northern boundary as "John R. Yale formerly Kate E. Crane."
- **September 13, 1901**: Per the *Brewster Standard*, John R. Yale held half-interest in the Sodom school district's $300 acquisition of the former Presbyterian Church property (joint seller with Mrs. E. O. Baxter to Trustee Storm).

**The kinship between Enos C. Yale and John R. Yale is not established in the primary record reviewed here**, but John R.'s repeated involvement in real-estate transactions adjacent to the Yale Tract across the decade of the watershed takings is a documentary pattern more consistent with family succession than with arm's-length acquisition.
...
### CRANE'S MILLS — The Old Grist Mill and the Crane Family Commercial Cluster
...
**Joseph Crane day book, 1773** (per Bailey 1944): Bailey's "Historical Sketch of Brewster" cites Joseph Crane's 1773 day book as primary documentary evidence of pre-Revolutionary Crane family economic activity at Southeast. Joseph Crane is the Crane patriarch from whom the local toponym "Crane's Hill" / "Joe's Hill" descends. **The Crane family's commercial presence at Southeast pre-dates the Revolution.**
...
**The Crane family commercial cluster, east of the bridge (1875–1877)**: Three Crane operations were running on the east side of the Croton River bridge during the village's pre-watershed peak — distinct from the grist mill itself, which sat on the west:
- **"Squire Crane" — village blacksmith** (per *Brewster Standard*, May 4, 1877). Squire Crane operated a blacksmith shop east of the bridge, at the foot of the village's commercial corridor. His shop was distinct from the B.S.SH at the Lot 4/6 boundary (which was at the village center, not at the bridge).
- **"Crane's blacksmith shop" — second blacksmith reference** (per *Brewster Standard*, August 31, 1877, in the context of the de-roofed covered bridge).
- **Belden Crane — cider press operator** (per *Brewster Standard*, September 21, 1877). "Belden Crane is operating a cider press in this village; he is producing both vinegar and apple-whiskey."
- **The covered Croton bridge** (per *Brewster Standard*, August 31, 1877): "The bridge over the Croton, formerly enclosed with weather-boards and a roof, has been entirely rebuilt at the loss of those features." The Croton River bridge at Southeast Centre had originally been a covered bridge; the roof and side weather-boards were stripped (or storm-removed) in early 1877.

**Together with the grist mill, blacksmith shop, and Joseph Crane's 1773 day book at the headwaters of the Crane family's Southeast presence, the Crane name traces a continuous commercial thread along the Croton River from 1773 through the 1890 watershed taking — over 117 years.** **The relationship between Joseph Crane (1773), James Z. Crane (1846 Yale Tract grantee), Squire Crane (1877 blacksmith), Belden Crane (1877 cider press), and the Crane Mills sold by Jacob O. Howes in 1836 has not been fully reconstructed in primary sources reviewed in this research and is a research target.**
...
**The wagon-building trade as a continuous corridor industry, 1826–1890**: Per Seth B. Howes's direct testimony in the *Brewster Standard*, February 25, 1887 ("The Old Showmen"), the four wagons of the founding 1826 Howes & Turner circus tour — the founding event of the American tent-circus industry — were **built by Mr. Cole, the father of George Cole of Southeast Centre**, with iron work by Phineas Trowbridge of the same village, painted white and red. **George Cole's father was therefore the wagon-builder for the founding tour of the American circus industry — meaning the wagon-building trade documented at the corridor extends continuously from the 1826 founding tour through the 1890 watershed taking, with the elder Cole and George Cole as successive proprietors.**

**The end** (December 6, 1889 *Brewster Standard* — ambiguous which factory specifically; see Wright & Co. above). **July 1890 watershed Awards article**: reports Cole "**driven out of his home and away from his business**." City took 37 of 44 acres, residence, barn, **wagon shop**, and all his water power. Award **$8,306.83**. Newspaper observed "**water power has proved to be a very knotty question throughout the whole proceeding**."

### A. BURCH — Burch & Beers, Fur Hats
A. Burch labeled at **lower end of Main Street** on 1867 Beers map. Beers Business Directory: "**Burch & Beers — Manufacturers of Fur Hats.**" Two hat operations in one village (Burch & Beers + J.O. Howes Hat Factory at Sodom Corners). Burch parcel was in Main Street cluster (Tax Map Section 57.17) distributed through John K. Wyatt insolvency 1840s-1850s. Taken by City in watershed proceedings. **OPEN: no deed research yet.**
...
**Warren's commercial activity, February 1887**: The *Brewster Standard*, February 25, 1887 ("Old Showmen" issue) carried a small advertisement: "**For Sale or to Rent — That Two-Story Frame House on the Hillside facing the Old Croton Turnpike Road, lately occupied by W. Warren. Apply to Mrs. W. Warren, Sodom.**" Even before the watershed taking made the rental market untenable, Mrs. Warren was already trying to dispose of her residence — placing the house on the market less than five months before the formal July 22, 1887 New Aqueduct Notice.

### S.O. CROSBY (upper) — Main Street north side
**= Seth S. Crosby (Sears Crosby in period sources).** "S.O." = engraver's misreading of "S.S." Confirmed by:
...
**See "The Crosby Family — Disambiguation" in Part 5 for Seth S. = Sears Crosby identity confirmation, including his brother Hart Crosby's role in the founding 1826 American tent-circus tour, and the 1857 Baker & Mygatt insolvency at Liber 31/526 that ended Seth's Southeast Centre tenure.**
...
**Cole's father built the founding 1826 circus wagons**: Per Seth B. Howes's direct testimony in the *Brewster Standard*, February 25, 1887 ("The Old Showmen"), **"the wagons used by the company were built by Mr. Cole, father of Mr. George Cole, the present resident of Southeast Centre, and the iron work, including the boxes and skeins, was made by Phineas Trowbridge, of the same village. The bodies were painted white, with red running gear."** This places George Cole's father as the wagon-builder for the founding tour of the American tent-circus industry. **The wagon-building trade at Southeast Centre is therefore continuous from 1826 founding through the 1890 watershed taking, with the elder Cole and George Cole as successive proprietors of the Howes Street carriage and wagon shop.**
...
**Trustee elections were active community events.** Per the *Brewster Standard*, October 11, 1878, the **October 1878 trustee election** was contested: Ezra Wright won, defeating William Storm and Francis Burdick, with Morgan Townsend chairing. The vote count and chairman are recorded in the village column. **William Storm — the same name as the geographic anchor for the founding 1826 circus tent — appears here in a 1878 trustee role; whether the 1826 reference and the 1878 candidacy refer to the same man, or to a William and a William A. Storm in successive generations, has not been definitively established.**

When the original schoolhouse was taken in watershed proceedings, **same Common School District No. 6** acquired former Presbyterian church lot (Lot 10) for $300 in 1901 and built new schoolhouse on cleared lot. Continuity is documentary, not inferential — same district number in pre-watershed (1868 Beers) and post-watershed (June 28, 1901 BS; June 24, 1927 auction notice) records. The September 13, 1901 *Brewster Standard* names the parties to the 1901 transaction explicitly: **District Trustee Storm signed the $300 check; Emma O. Baxter and John R. Yale were joint sellers (each holding half interest)**. See Lot 10 entry for full transaction mechanics.
...
**Thad Knox painting trade, August 1877** (per *Brewster Standard*, August 31, 1877): "Mr. Thad Knox is doing the painting and kalsomining at the Presbyterian church, his son working with him." **Documents Thaddeus R. Knox's continued residence and active painting trade in summer 1877, alongside his son.** Project undertaken in advance of Rev. Macoubrey's return to the pulpit (the August 1877 unanimous congregational call). **The Knox painting work on the Presbyterian Church physically connects two key corridor structures during the same season — the Knox house at the foot of the village and the Presbyterian church at the village center.**
...
**W. WARREN's February 1887 advertisement appears in same column** — see W. Warren entry above for the cross-corridor pattern of village figures advertising sale or rental of their homes in 1887, immediately ahead of the formal July 1887 Aqueduct Notice.
...
- **Brewster Standard [date]** = Putnam County newspaper of record. **Note**: published under the name "Putnam County Standard" before the 1880 acquisition by E. W. Addis (per Bailey 1944). When stating a fact from a Standard reference dated before 1880, the source name "Putnam County Standard" is technically more correct than "Brewster Standard"; both refer to the same paper continuously published from August 1872 onward, and "Brewster Standard" is acceptable as a generalized reference. **When citing the *actual* masthead under which an article appeared, use the masthead the article carried at that date.**
- **Roberts 1876** = L. H. Roberts Centennial Address, July 14, 1876.
- **Bailey 1944** = Laura Voris Bailey, "Historical Sketch of Brewster," *Brewster Standard*.
...
- **Conflict identification**: when primary and secondary sources conflict, name the conflict explicitly rather than choosing one silently. Example: Bailey 1944 frames the founding 1826 circus as Nathan Howes's "Old Bet" elephant tour (citing Earl Chapin May 1932). The 1887 *Brewster Standard* "Old Showmen" article — drawing on Seth B. Howes's direct testimony at age 71 — describes the founding as a Russian-duck canvas tent, not an elephant tour. The 1887 article is direct testimony from a participant; Bailey 1944 is tertiary (citing May 1932). The 1887 article is the stronger source. **When asked about the founding circus, lead with the 1887 testimony and note Bailey 1944's elephant framing as a secondary-source variant** — don't suppress the conflict.
...
- Surrogate's Court records for: Scribner estate (Lot 9 — closing the 82-year inheritance gap), Knox family (Thaddeus R. + Theodore Raymond death dates), W.H. Crosby (1854-1867 widow's interest passage), Godfrey gap (Lot 1 Heartfield → Godfrey), **Martha M. Crosby → Godfrey (the 1876–1926 Lot 2/Stonehenge-east-of-the-road inheritance gap, working hypothesis: passes through probate rather than recorded deed)**
- **Mrs. William B. Reed maiden name** (the 1948 Christaud opening article identifies her as "daughter of Col. Crosby" but does not give her birth name; primary-source confirmation is needed before committing the maiden name)
- **William Storm residence** — geographic anchor for the founding 1826 circus tent, the 1882 New England Railroad rerouting, and the 1901 school district transaction. Definitive location on the 1867 Beers map and the question of one Storm vs. two (William and William A. Storm in successive generations) remains open.
- **Yale family kinship** — the relationship between Enos C. Yale (1858–1876 owner of the Yale Tract) and John R. Yale (1877–1925 corridor presence) is not established in primary sources reviewed in this research, though John R.'s repeated involvement in real-estate transactions adjacent to the Yale Tract across the decade of the watershed takings is more consistent with family succession than arm's-length acquisition.
- **F.C. Yale identity** — the 1876 Reed map shows a second Yale household at Southeast Centre during the decade before Enos C. Yale's death; identity and kinship not yet established.
- **Hotel de Jonson** — referenced in the *Brewster Standard*, March 23, 1877. Not on the 1867 Beers map. Single-source contaminated reference; whether the structure stood at Southeast Centre or in a neighboring hamlet (Milltown, Brewsters proper) is not yet established. Out of scope for current Southeast Centre research absent corroborating primary source.
- **Bailey 1944 vs. 1887 *Brewster Standard* "Old Showmen" reconciliation** — the elephant story (Bailey 1944, citing May 1932) and the Russian duck tent story (1887 *Brewster Standard*, Seth B. Howes's direct testimony) appear to describe the same 1826 tour. Whether these are two separate tours, a single tour with both an elephant and a tent, or one of them is folk-memory variant of the other, is not yet definitively resolved.
- **Crane family genealogy 1773–1877** — the relationship between Joseph Crane (1773 day book), James Z. Crane (1846 Yale Tract grantee), Squire Crane (1877 blacksmith east of bridge), Belden Crane (1877 cider press), and the Crane Mills sold by Jacob O. Howes in 1836 has not been fully reconstructed. Multi-generational Crane family thread along the Croton River from 1773 through 1890 — primary research target.
